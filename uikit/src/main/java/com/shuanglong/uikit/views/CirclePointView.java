...
public class CirclePointView extends View
{
    ...
    private Path mPath;
    private CirclePoint mHeadPoint;
    private CirclePoint mFootPoint;
    ...
    {
        setAlpha(0);
        mHeadPoint = new CirclePoint();
        mFootPoint = new CirclePoint();
    ...
    {
        setPivotX(getHeadCirclePoint().getX());
        setPivotY(getFootCirclePoint().getY());
    ...
    public CirclePoint getHeadCirclePoint()
    {
        return mHeadPoint;
    }

    public CirclePoint getFootCirclePoint()
    {
        return mFootPoint;
    }
